...
| Marca "Aduanas Verdes" (oficinas físicas, distinto de la fila anterior) | Concepto de marca para una red de oficinas físicas de tramitación (certificados, permisos, documentos de comercio exterior) que operarían usando el sistema de sicr3p por dentro — no requiere la integración en línea con aduanas de la fila anterior (que sigue excluida). Hay moodboard de marca (paleta, tipografía, señalética, papelería, mock de app). **Solo documentado por ahora, sin código** — el usuario no tiene preferencia todavía sobre si se necesita marca blanca (white-label) en el panel u otra cosa concreta. | Decisión de negocio sobre qué necesita el panel para soportar oficinas con marca propia (si es que se decide avanzar). |
