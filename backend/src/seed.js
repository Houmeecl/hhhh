  ...
  if (cnCount[0].n === 0) {
    await query(
      `INSERT INTO cuentas_naturales (codigo, nombre, unidad, tipo, activo, factores, marco, fuente, notas) VALUES
       ('AGUA','Agua','m3','flujo', true,  $1,'Plan Nacional de Cuentas Ambientales de Chile (MMA) — SEEA Marco Central (ONU)','DEFRA 2024 — agua potable (red)','Consumo hídrico derivado de documentos.'),
      ...
      [
        JSON.stringify({ agua_kgco2e_m3: 0.41 }),
